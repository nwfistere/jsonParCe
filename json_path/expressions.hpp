...
public:
  ...
  node_provider(json_node_t root, json_node_t current)
      : current_node(current), root_node(root) {}
  ~node_provider() = default;

  json_node_t get_current_node() { return current_node; }

  void set_current_node(json_node_t node) { current_node = node; }

  json_node_t get_root_node() { return root_node; }

  void set_root_node(json_node_t node) { root_node = node; }
};
...
struct binary_expression : public expression {
  ...
  binary_expression(expression_t l, OPERATION operation, expression_t r)
      : expression(operation), left(l), right(r) {}

  void get_child_expression_values(value_expression_t &l_value, bool *l_bool,
                                   value_expression_t &r_value, bool *r_bool) {
  ...
  void set_right(expression_t new_right) { right = new_right; }
};
...
struct unary_expression : public expression {
  ...
  unary_expression(OPERATION operation, expression_t expr)
      : expression(operation), expr(expr) {}
};

struct or_expression : public binary_expression {
  or_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::OR, r) {}
...
struct and_expression : public binary_expression {
  and_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::AND, r) {}
...
struct equivalent_expression : public binary_expression {
  equivalent_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::EQUAL, r) {}
  ...
  virtual bool eval() override {
    if (value_expression::is_value(left) && value_expression::is_value(right)) {
      ...
      value_expression *r_result =
          dynamic_cast<value_expression *>(right.get());
...
struct not_equivalent_expression : public binary_expression {
  not_equivalent_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::NOT_EQUAL, r) {}
...
struct le_expression : public binary_expression {
  le_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::LE, r) {}

  virtual bool eval() override {
    value_expression_t l_value =
        std::dynamic_pointer_cast<value_expression>(left);
    value_expression_t r_value =
        std::dynamic_pointer_cast<value_expression>(right);
...
struct lt_expression : public binary_expression {
  lt_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::LT, r) {}
...
struct ge_expression : public binary_expression {
  ge_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::GE, r) {}
...
struct gt_expression : public binary_expression {
  gt_expression(expression_t l, expression_t r)
      : binary_expression(l, OPERATION::GT, r) {}
...
struct not_expression : public unary_expression {
  ...
  virtual bool eval() override { return !expr->eval(); }
};

struct grouped_expression : public unary_expression {
  grouped_expression(expression_t expr)
      : unary_expression(OPERATION::PARENTHESES, expr) {}
...
struct literal_value_expression : public value_expression {
  ...
  literal_value_expression(json_node_t node)
      : value_expression(LITERAL), value(node) {}

  bool eval() override { return (bool)(*get_value()); }

  json_node_t get_value() override { return value; }
};
...
struct selector_expression : public value_expression {
  ...
  selector_expression(value_expression_t l,
                      std::shared_ptr<selector_child_expression> r)
  ...
  json_node_t get_value() override {
    ...
    if (r_result->type == STRING) {
      ...
      // wildcard // TODO: wildcard expression could probably go away with just
      // a check here to do it's logic.
      return r_result;
    }
...
struct provided_node_expression : public value_expression {
  ...
  bool eval() override { throw std::invalid_argument("invalid type"); }
};
...
struct current_node_expression : public provided_node_expression {
  ...
  json_node_t get_value() override { return m_provider->get_current_node(); }
};

struct root_node_expression : public provided_node_expression {
  root_node_expression(node_provider_t node) : provided_node_expression(node) {}

  json_node_t get_value() override { return m_provider->get_root_node(); }
};
...
struct sub_filter_expression : public value_expression {
  ...
  // TODO: inherit unary_expression and provided_expressions, they will need to
  // be virtual.
  sub_filter_expression(value_expression_t outer_expr,
                        std::shared_ptr<literal_value_expression> inner_expr,
                        node_provider_t provider)
      : value_expression(OPERATION::FILTER), m_provider(provider),
...
struct multi_filter_wrapper_expression : public expression {
  ...
  multi_filter_wrapper_expression(expression_t expr)
      : expression(MULTI), expr(expr) {}

  bool eval() { return expr->eval(); }
};
