...
std::string get_full_sub_filter_statement(const std::string &statement) {
  return get_bracket_substatement(statement, '[', ']');
}

void get_number(const std::string &str, json_parce_int_t &i,
...
std::string get_function_parameter(const std::string &statement) {
  size_t i = 0;
...
std::string get_bracket_substatement(const std::string &statement,
                                            const char lbracket,
                                            const char rbracket) {
